...
<header role="banner">
    ...
    <main>
        ...
        <div class="container-fluid" >
            <div class="row" id="dbox" style="font-family: 'Exo 2', sans-serif;color: #121f40" >
                <div class="col-md-9 mt-2 ml-1 mb-2" style="border: 5px solid #121f40;" id="detailbox">
                    <h1 class="display-4 pt-1 mb-0" style="font-family: 'Exo 2', sans-serif;"><?= $vcname; ?></h1><br>
                    <div class="row">
                        <div class="col-md-3" ><h3>Institute</h3><?= $vname; ?></div>
                        <div class="col-md-2"><img src="<?= $vphoto; ?>" alt="" width="100px" height="50px"></div>
                        <div class="col-md-2"><i class="fa fa-phone-square-alt fa-2x"></i>&nbsp;<h3><?= $vphone; ?></h3></div>
                        <div class="col-md-2"><i class="fas fa-graduation-cap fa-2x"></i>&nbsp;<h3><?= $vtype; ?></h3></div>
                    </div>
                    <hr>
                ...
                <div class="col-md-2" id="addrow">
                    <div class="ui message mt-1">
                        <div class="header">
                            Spaces Available for advertise here
                        </div>
                        <p>CallUs-0773265517</p>
                    </div>
                </div>
            </div>
        </div>
