...
<head>
    ...
    <link href="https://fonts.googleapis.com/css?family=Abril+Fatface|Bahianita|Bree+Serif|DM+Sans|Exo+2|Lobster|Open+Sans+Condensed:300|Pacifico|Pathway+Gothic+One|Playfair+Display|Righteous|Russo+One|Sniglet|Ubuntu+Condensed&display=swap" rel="stylesheet">
        ...
        <section class="bg-gray-7">
            ...
            <div class="container" id="bread">
                <ul class="breadcrumbs-custom-path">
                    ...
                    <li><a href="courses.php">Courses in Admin Panel</a></li>
                    <i class="fas fa-arrow-right"></i>
                    <li class="active">Details of Course</li>
                    <li>
...
<section>
        ...
        <div class="data-bar shadow mt-2" style="background-image: linear-gradient(-90deg, #2980b9, #2c3e50);>
                        <div class="data-bar-content partner-count-1">
                            <div class="container-fluid">
                                <div class="row mb-5" style="height: 125px">
                                <div class='col-md-2 bg-white'>
                                    <div class="partner-image-wrapper">
                                        <div class="partner">
                                           <img src='<?= $vphoto; ?>' alt='' class='ml-5 mt-3' width='150px' height='75px'></div>
                                        </div>
                                    </div>
                                    <div class='col-md-10' style="background-image: linear-gradient(-90deg, #2980b9, #2c3e50);">
                                    <div class="program">
                                        <div class="type">
                                            <div class="title">
                                                <h2 class="text-white mt-4 mb-2" style="margin-bottom: 10px;font-size: 2rem;font-family: Georgia,Times,Times New Roman,serif;"><?= $vcname; ?></h2>
                                            </div>
                                        </div>
                                    </div>
                                    </div>
        ...
        <div class="gradient-wrapper program-body">
            ...
            <div class="col-lg-4">
                                       ...
                                       <i class="fas fa-graduation-cap fa-2x" style="margin-left: 12px;color: white;margin-top: 12px;"></i>
                                         ...
                                         <div class='col-md-8'>
                                         <div class='row'><h3>Course Type</h3></div><div class='row'><?= $vtype; ?></div></div>
                                       ...
                                       <i class="fas fa-location-arrow fa-2x" style="margin-left: 12px;color: white;margin-top: 12px;"></i>
                                         ...
                                         <div class='col-md-8'>
                                         <div class='row'><h3 class='text-dark'>Institute</h3></div><div class='row'><?= $vname; ?></div></div>
                                       ...
                                       <i class="far fa-clock fa-2x" style="margin-left: 15px;color: white;margin-top: 13px;"></i>
                                         ...
                                         <div class='col-md-8'>
                                         <div class='row'><h3>Duration</h3></div><div class='row'><?= $vduration; ?></div></div>
                                       ...
                                       <i class="fas fa-money-check fa-2x" style="margin-left: 11px;color: white;margin-top: 15px;"></i>
                                         ...
                                         <div class='col-md-8'>
                                         <div class='row'><h3>Cost</h3></div><div class='row'><?= $vcost; ?></div></div>
                                       ...
                                       <i class="fas fa-phone fa-2x" style="margin-left: 11px;color: white;margin-top: 15px;"></i>
                                         ...
                                         <div class='col-md-8'>
                                         <div class='row'><h3>Contact Details</h3></div><div class='row'><?= $vphone; ?></div></div>
...
<script src="../../css/others/font-awesome.min.css"></script>
